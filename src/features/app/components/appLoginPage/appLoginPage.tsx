      ...
      <Col span={24} lg={{ span: 12 }} md={{ span: 12 }}>
            <div className="bg-[#374756] h-full flex flex-col items-center justify-center">
              <div className="Login-text flex flex-col items-center justify-center">
                ...
                <h2 className="font-semibold text-2xl mb-2 text-white mt-[10px]">SHOPDI ECOMMERCE ADMIN</h2>
                <p className="text-lg text-white">Sàn thương mại điện tử thế hệ mới</p>
              </div>
            ...
            <div className="pt-[250px] flex flex-col justify-center items-center">
                ...
                <h5 className='text-[rgba(0,0,0,0.45)] text-sm'>Shopdi chào mừng bạn đã quay lại!</h5>
                ...
                <Form.Item>
                    ...
                    <Button className="w-full mt-10 bg-black text-base text-white h-10 hover:bg-[#fdc500] hover:border-none hover:outline-none" htmlType="submit">
                      Đăng nhập
                    </Button>
                  </Form.Item>
              </Form>
